...
- 源计划：iterations/ios-v1/plan.md §8 IOS-P0。当前 Git main 3c003f9；已有未跟踪 iOS 方案文件保留。
...
待工程创建并实际验证：swift test --package-path ios/Packages/ChattyKit --scratch-path .tools/ios-swift-build；scripts/ios-dev-loop.sh；agent-device replay iterations/ios-v1/flows/p0-navigation.ad --platform ios。

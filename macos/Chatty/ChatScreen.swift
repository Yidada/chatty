        ...
        VStack(spacing: 0) {
            ...
            ScrollViewReader { proxy in
                ScrollView {
                    ...
                    }.padding(28).frame(maxWidth: 980).frame(maxWidth: .infinity)
                }
    ...
    private var composer: some View {
        VStack(spacing: 10) {
            ...
            HStack(alignment: .bottom, spacing: 10) {
                ...
                }.keyboardShortcut(.return, modifiers: .command).help("发送 · ⌘Return").disabled(!model.canSend).accessibilityLabel("发送").accessibilityIdentifier("chat.send")

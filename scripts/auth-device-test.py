...
try:
 ...
 s.tap('Loop Test Workspace');s.expect('历史');s.shot('connected')
 ...
 restart();s.expect('历史');s.shot('cold-start-restored')
 ...
 control(200);s.tap('重新加载');s.expect('历史');s.shot('recovered')

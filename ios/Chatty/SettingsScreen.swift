...
private struct ResourceListScreen: View {
    ...
    var body: some View {
        ...
        .navigationTitle(page.rawValue).navigationBarTitleDisplayMode(.inline).scrollContentBackground(.hidden).background(ChattyTheme.background)
...
private struct ResourceDetails: View {
    ...
    var body: some View {
        ...
        }.navigationTitle(title).navigationBarTitleDisplayMode(.inline).scrollContentBackground(.hidden).background(ChattyTheme.background)
    }
}
